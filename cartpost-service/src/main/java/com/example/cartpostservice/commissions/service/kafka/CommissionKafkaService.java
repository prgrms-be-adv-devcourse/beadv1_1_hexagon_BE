...
public class CommissionKafkaService {
    ...
    @Transactional
    public void createProducer(String commissionCode, CommissionUpsertRequest request){
    ...
    public void updateProducer(String commissionCode, CommissionUpsertRequest request) {
